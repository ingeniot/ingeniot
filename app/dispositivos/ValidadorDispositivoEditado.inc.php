...
class ValidadorDispositivoEditado  extends ValidadorDispositivo{
  private $cambios_realizados;
  private $nombre_original;
  public function __construct($nombre,$nombre_original,$tipo,$tipo_original,$etiqueta,$etiqueta_original,$descripcion,$descripcion_original,$conexion) {
