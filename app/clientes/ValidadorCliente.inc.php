  ...
  protected $error_tipo;
    ...
    protected function validar_nombre($conexion, $nombre) {
        ...
        if (!$this->variable_iniciada($nombre)) {
            return "Debes escribir un nombre de cliente";
        } else {
            $this->nombre = $nombre;
        }
        if (strlen($nombre) < 1) {
        ...
        if (RepositorioCliente::nombre_existe($conexion, $nombre)) {
            return "El nombre de cliente ya esta en uso";
        }
        return"";
    }
    protected function validar_tipo($conexion, $tipo) {
        ...
        if (!$this->variable_iniciada($tipo)) {
            return "Debes escribir un tipo de cliente";
        } else {
            $this->tipo = $tipo;
        }
        if (strlen($tipo) < 1) {
