...
include_once "./ValidadorUsuarioEditado.inc.php";
...
if (isset($_POST["nombre"])) {  //Hace la validación si se pulso el boton Enviar datos
  ...
  $validador = new ValidadorUsuarioEditado($_POST["email"], $_POST["email_original"], $_POST["nombre"], $_POST["nombre_original"], $_POST["apellido"], $_POST["apellido_original"], $_POST["descripcion"], $_POST["descripcion_original"],Conexion::obtener_conexion()); //Crea una instancia para validacion de los datos enviados
  if ($validador->registro_valido()) { //Verifica que todos los datos ingresados sean validos
    $usuario_editado = RepositorioUsuario::actualizar_usuario(Conexion::obtener_conexion(), $id,
