...
//$mensaje_titulo="";
if($token_generado){
  include "EnviarEmailRecuperacion.inc.php";
  $mensaje_titulo="Recuperación de clave";
  $mensaje1="El token fue generado exitosamente";
  $mensaje2="Revisar correo con las instrucciones";
  }
else{
