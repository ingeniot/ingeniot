<?php
include_once RUTA_APP_EMAIL."PHPMailer.php";
include_once RUTA_APP_SYS_CONFIG."RepositorioSysConfig.inc.php";
include RUTA_APP_USUARIOS_TOKENS."CuerpoEmailActivacion.inc.php";
//echo $cuerpo;
...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Activar cuenta IngenIoT';
    ...
    $mail->send();
    echo 'Ha enviado el correo de activación';
} catch (Exception $e) {
    echo 'El correo de activación no pudo ser activado. Error: '. $mail->ErrorInfo;
}
