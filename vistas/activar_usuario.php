...
//falta hacer operacion como transaccion para poder ejecutarlo sono si se realizo completamente
...
<div class="app" id="app">
  ...
  <div class="center-block w-xxl w-auto-xs p-y-md">
      ...
      <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
        ...
        <form role="form" method="post" action="<?=RUTA_ACTIVAR_USUARIO."/".$token_recibido?>" name="formulario-guardar-clave" >
