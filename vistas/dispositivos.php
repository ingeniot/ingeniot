  ...
  <!-- content -->
    <div id="content" class="app-content box-shadow-z0" role="main">
      ...
      <div ui-view class="app-body" id="view">
        ...
        <div class="padding">
          <?php
          include "plantillas/administrador/dispositivos/dispositivos.inc.php";
          ?>
...
?>
<!--0713 Libreria JS dispositivos-->
  <script src="../app/dispositivos/dispositivos.js?v=<?php echo(rand());?>"></script>
