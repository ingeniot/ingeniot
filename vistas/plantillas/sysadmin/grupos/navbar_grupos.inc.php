...
<div class="col-sm-1 text-sm-right">
  <button id="agregar-grupo" class="md-btn md-fab md-mini m-b-sm green" ><!--md-mini achica boton-->
    <i class="material-icons md-24"></i> <!--Agregar grupo-->
  </button>
</div>
      ...
      <div class="input-group">
        ...
        <span class="input-group-btn">
          <button type="submit" class="btn btn-sm btn-default b-a no-shadow">
            <i class="fa fa-search"><!--Buscar grupo-->
            </i>
          </button>
        </span>
      </div>
