<div id="formulario-agregar-grupo" class="formulario box">
  ...
  <div class="box-body">
    <form role="form">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input id="nombre" autofocus type="text" class="form-control" name="nombre" placeholder="Nombre *">
        </div>
      </div>
      <div class="form-group row">
        <label for="tipo" class="col-sm-2 form-control-label">Tipo</label>
        <div class="col-sm-10">
          <input  id="tipo" type="text" class="form-control" name="tipo" placeholder="Tipo">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row m-t-md">
        <div class="col-sm-6 col-sm-offset-2 center">
          <button id="cancelar-agregar-grupo" type="submit" class="btn cancel btn-block white">Cancelar</button>
          </div>
          <div class="col-sm-6 col-sm-offset-2 center">
            <button id="confirmar-agregar-grupo" type="submit" class="btn primary btn-block">Agregar</button>
        </div>
        </div>
      </form>
    </div>
