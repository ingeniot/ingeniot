<div id="formulario-agregar-recurso" class="formulario box">
    ...
    <form role="form">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6 col-sm-offset-2 center">
          <button id="cancelar-agregar-recurso" type="submit" class="btn cancel btn-block white">Cancelar</button>
          </div>
          <div class="col-sm-6 col-sm-offset-2 center">
            <button id="confirmar-agregar-recurso" type="submit" class="btn primary btn-block">Agregar</button>
        </div>
        </div>
      </form>
    </div>
