...
<div class="col-sm-1 text-sm-right">
  <button id="agregar-recurso" class="md-btn md-fab md-mini m-b-sm green" ><!--md-mini achica boton-->
    <i class="material-icons md-24"></i> <!--Agregar recurso
    -->
  </button>
</div>
  ...
  <form class="navbar-form form-inline navbar-item m-l v-m ng-pristine ng-valid ng-scope ng-submitted" role="search" style="">
    <div class="form-group l-h m-a-0">
      <div class="input-group">
        <input type="text" class="form-control b-a form-control-sm" placeholder="Buscar recurso...">
