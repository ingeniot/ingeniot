<div id="formulario-editar-administrador" class="formulario box">
    ...
    <form role="form">
      ...
      <div class="form-group row m-t-md">
        <div class="col-sm-6 col-sm-offset-2 center">
          <button id="cancelar-editar-administrador" type="submit" class="btn cancel btn-block white">Cancelar</button>
        </div>
        <div class="col-sm-6 col-sm-offset-2 center">
          <button id="confirmar-editar-administrador" type="submit" class="btn primary btn-block">Modificar</button>
        </div>
      </div>
    </form>
  </div>
