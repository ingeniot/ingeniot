<div class="row">
<div class="col-sm-9">
  <h2 class="m-b-0 _300 ng-binding"><?= $titulo." ".$nombre_grupo ?></h2>

</div>
<div class="col-sm-1 text-sm-right">
  <button id="agregar-administrador" class="md-btn md-fab md-mini m-b-sm green" ><!--md-mini achica boton-->
    <i class="material-icons md-24"></i> <!--Agregar administrador
    -->
  </button>
</div>
  ...
  <form class="navbar-form form-inline navbar-item m-l v-m ng-pristine ng-valid ng-scope ng-submitted" role="search" style="">
    <div class="form-group l-h m-a-0">
      <div class="input-group">
        <input type="text" class="form-control b-a form-control-sm" placeholder="Buscar administrador...">
