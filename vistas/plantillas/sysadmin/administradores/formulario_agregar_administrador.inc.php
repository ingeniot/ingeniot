<div id="formulario-agregar-administrador" class="formulario box">
  ...
  <div class="box-body">
    <form role="form">
      <input id="id-grupo" type="text" class="form-control" name="id-grupo" value="<?=$id_grupo?>">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6 col-sm-offset-2 center">
          <button id="cancelar-agregar-administrador" type="submit" class="btn cancel btn-block white">Cancelar</button>
          </div>
          <div class="col-sm-6 col-sm-offset-2 center">
            <button id="confirmar-agregar-administrador" type="submit" class="btn primary btn-block">Agregar</button>
        </div>
        </div>
      </form>
    </div>
