<div class="row">
<div class="col-sm-9">
  <h2 class="m-b-0 _300 ng-binding"><?php echo $titulo ?>Listar dominios por grupo</h2>

</div>
<div class="col-sm-1 text-sm-right">
  <button id="agregar-dominio" class="md-btn md-fab md-mini m-b-sm green" ><!--md-mini achica boton-->
    <i class="material-icons md-24"></i> <!--Agregar dominio-->
  </button>
</div>
  ...
  <form class="navbar-form form-inline navbar-item m-l v-m ng-pristine ng-valid ng-scope ng-submitted" role="search" style="">
    <div class="form-group l-h m-a-0">
      <div class="input-group">
        <input type="text" class="form-control b-a form-control-sm" placeholder="Buscar dominio...">
        <span class="input-group-btn">
          <button type="submit" class="btn btn-sm btn-default b-a no-shadow">
            <i class="fa fa-search"><!--Buscar dominio-->
            </i>
          </button>
        </span>
      </div>
