<div  id="formulario-agregar-dominio" class="formulario box">
  ...
  <div class="box-body">
    <form role="form">
      ...
      <div class="md-form-group row">
        ...
        <div class="col-sm-9">
          <input id="tipo" type="text" class="form-control" placeholder="Tipo de dominio *" name="tipo">
        </div>
      </div>
      <div class="form-group row">
        <label for="etiqueta"  class="col-sm-3 form-control-label"><b>Etiqueta</b></label>
        <div class="col-sm-9">
          <input id="etiqueta" type="text" class="form-control" placeholder="Etiqueta *" name="etiqueta">
        </div>
      </div>
      <div class="md-form-group row">
      ...
      <div class="form-group row m-t-md">
        <div class="col-sm-6 col-sm-offset-2 center">
          <button id="cancelar-agregar-dominio" class="btn cancel btn-block white" >Cancelar</button>
        </div>
        <div class="col-sm-6 col-sm-offset-2 center">
          <button id="confirmar-agregar-dominio" name="agregar-dominio" class="btn primary btn-block p-x-md">Agregar</button>
        </div>
