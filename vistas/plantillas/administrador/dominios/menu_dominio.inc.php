<div id="menu-dominio" class="white box-shadow menu">
    <!--navbar-->
  <div class="navbar navbar-toggleable-sm flex-row align-items-center">
    ...
    <div class="collapse navbar-collapse" id="collapse">
      ...
      <ul class="nav navbar-nav ml-auto flex-row">
        <li class="nav-item">
          <button id = "editar-dominio" class="md-btn md-fab md-mini m-b-sm"
          style="background-color:DodgerBlue;">
          <i class='material-icons md-24'></i> <!--Editar dominio--></button>

        </li>
        <li class="nav-item  pos-stc-xs mg-2">
          <button id="cerrar-menu-dominio"  class="md-btn md-fab md-mini m-b-sm deep-orange-500"><!--md-mini achica boton-->
            <i class='material-icons md-20'></i> <!--Agregar dominio-->
          </button>
        </li>
        <li class="nav-item">
          .........
  ...
  <div class="tab-content p-a m-b-md">
    ...
    <div class="tab-pane animated fadeIn text-muted active" id="tab1" aria-expanded="true">
      ...
      <p class="m-b btn-groups">
        ...
        <button class="btn btn-fw" disabled="disabled">Disabled</button>-->
                          ...
                          <!--botones-->
                                        <!--detalles-atributos-->
      <div id="dominio-detalles"  class="vista-detalles" >
    ...
    <div class="md-form-group">
      ...
      <input id="etiqueta-actual" class="md-input"  type="text" name="etiqueta" readonly="readonly">
    </div>
  </div>
  <div class="col-sm-12">
  <div class="md-form-group">
    <label>Descripción</label>
    <input id="descripcion-actual" class="md-input"  type="text" name="descripcion" readonly="readonly">
  </div>
</div>
</div>
      </form>
  ...
  <div class="tab-pane animated fadeIn text-muted muted" id="tab4" aria-expanded="true">
    <h2>eventos</h2>
  </div>
