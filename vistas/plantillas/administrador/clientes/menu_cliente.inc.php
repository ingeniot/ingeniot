<div id="menu-cliente" class="white box-shadow menu">
  <div class="navbar navbar-toggleable-sm flex-row align-items-center">
    <div class="collapse navbar-collapse" id="collapse">
      ...
      <ul class="nav navbar-nav ml-auto flex-row">
        <li class="nav-item">
          <button id = "editar-cliente" class="md-btn md-fab md-mini m-b-sm"
          style="background-color:DodgerBlue;">
          <i class='material-icons md-24'></i> <!--Editar dispositivo--></button>

        </li>
        <li class="nav-item  pos-stc-xs mg-2">
          <button id="cerrar-menu-cliente" class="md-btn md-fab md-mini m-b-sm deep-orange-500"><!--md-mini achica boton-->
  ...
  <div class="tab-content p-a m-b-md">
            <div class="tab-pane animated fadeIn text-muted active" id="tab1" aria-expanded="true">
              ...
              <form class="" role="form" method="post" action="<?=RUTA_USUARIOS?>" name="form">
                  <input id="id-actual" type="hidden"  name="id-cliente" readonly="readonly">
                 <input id="cliente-actual" type="hidden" name="nombre-cliente" readonly="readonly">
                    <button type="submit" href="" class="btn btn-fw dark">Usuarios</button>
              </form>
                <button class="btn btn-fw dark">Dominios</button>
                <button class="btn btn-fw dark">Dispositivos</button>
                <button class="btn btn-fw dark">Tableros</button>
                <button class="btn btn-fw dark">Eliminar cliente</button>
              ...
              <?php
              include "detalles_cliente.inc.php";
              ?>
            </div>
