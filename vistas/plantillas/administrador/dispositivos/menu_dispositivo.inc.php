  ...
  <div class="tab-content p-a m-b-md">
    ...
    <div class="tab-pane animated fadeIn text-muted active" id="tab1" aria-expanded="true">
      ...
      <div id="dispositivo-detalles"  class="vista-detalles" >
        <form class="" role="form" method="post" target="dispositivos.php" name="form">
      ...
      <div class="md-form-group">
        <label>Tipo</label>
        <input  id="tipo-actual" class="md-input" type="text" placeholder="Tipo de dispositivo *" name="tipo" readonly="readonly">
      </div>
    </div>
    <div class="col-sm-6">
    <div class="md-form-group">
