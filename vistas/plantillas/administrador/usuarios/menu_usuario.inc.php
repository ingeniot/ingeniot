<div id="menu-usuario" class="white box-shadow menu">
  <div class="navbar navbar-toggleable-sm flex-row align-items-center">
    <div class="collapse navbar-collapse" id="collapse">
      ...
      <ul class="nav navbar-nav ml-auto flex-row">
        <li class="nav-item">
          <button id = "editar-usuario" class="md-btn md-fab md-mini m-b-sm"
          style="background-color:DodgerBlue;">
          <i class='material-icons md-24'></i> <!--Editar usuario--></button>

        </li>
        <li class="nav-item  pos-stc-xs mg-2">
          <button id="cerrar-menu-usuario" class="md-btn md-fab md-mini m-b-sm deep-orange-500"><!--md-mini achica boton-->
            <i class='material-icons md-20'></i> <!--Agregar usuario-->
          </button>
        </li>
        <li class="nav-item">
          .........
  ...
  <div class="tab-content p-a m-b-md">
            <div class="tab-pane animated fadeIn text-muted active" id="tab1" aria-expanded="true">
              <p class="m-b btn-groups">
                ...
                <button class="btn btn-fw dark">Ingresar como usuario</button>
            ...
            <!--    <button class="btn btn-fw info">Copiar ID</button>-->
              ...
              <?php
              include "detalles_usuario.inc.php";
              ?>
            </div>
